...
OUTPUT_FILE = BASE_DIR / "dashboard" / "catalog.json"
ANALYTICS_FILE = BASE_DIR / "data" / "analytics" / "curated_content_catalog.json"
...
ENRICHED_TITLES = [
    {
        ...
        "bridge_titles": ["Interstellar", "The Matrix", "Severance"],
        "radar": {
            "retention": 88,
    ...
    },
    {
        ...
        "bridge_titles": ["Inception", "Dune: Part Two", "Blade Runner 2049"],
        "radar": {
            "retention": 91,
    ...
    },
    {
        ...
        "bridge_titles": ["Chernobyl", "The Dark Knight", "The Imitation Game"],
        "radar": {
            "retention": 85,
    ...
    },
    {
        ...
        "bridge_titles": ["Joker", "The Batman", "The Boys"],
        "radar": {
            "retention": 94,
    ...
    },
    {
        ...
        "bridge_titles": ["Blade Runner 2049", "Interstellar", "Avatar: The Way of Water"],
        "radar": {
            "retention": 86,
    ...
    },
    {
        ...
        "post_finale_vulnerability": 42, # Post-finale binge churn risk!
        "ad_yield_cpm": 44.0,
        "ad_tolerance_minutes": 18,
        "bridge_titles": ["Dark", "Wednesday", "Severance", "Black Mirror"],
        "radar": {
            "retention": 95,
    ...
    },
    {
        ...
        "bridge_titles": ["Baahubali 2", "K.G.F: Chapter 2", "Jawan"],
        "radar": {
            "retention": 89,
    ...
    },
    {
        ...
        "bridge_titles": ["The Bear", "Billions", "Mad Men"],
        "radar": {
            "retention": 92,
    ...
    },
    {
        ...
        "bridge_titles": ["Succession", "Beef", "Fleabag"],
        "radar": {
            "retention": 93,
    ...
    },
    {
        ...
        "bridge_titles": ["Better Call Saul", "Ozark", "Narcos", "Fargo"],
        "radar": {
            "retention": 98,
            "capital_efficiency": 97,
            "churn_defense": 99,
    ...
    },
    {
        ...
        "post_finale_vulnerability": 45, # Very high post-binge cancellation threat
        "ad_yield_cpm": 46.0,
        "ad_tolerance_minutes": 20,
        "bridge_titles": ["Alice in Borderland", "All of Us Are Dead", "Parasite"],
        "radar": {
            "retention": 94,
    ...
    },
    {
        ...
        "ad_yield_cpm": 35.0,
        "ad_tolerance_minutes": 25,
        "bridge_titles": ["Black Mirror", "Dark", "Inception"],
        "radar": {
            "retention": 91,
            "capital_efficiency": 94,
            "churn_defense": 91,
    ...
    },
    {
        ...
        "ad_yield_cpm": 31.0,
        "ad_tolerance_minutes": 32,
        "bridge_titles": ["Oldboy", "Squid Game", "Memories of Murder"],
        "radar": {
            "retention": 90,
            "capital_efficiency": 97,
            "churn_defense": 88,
    ...
    },
    {
        ...
        "bridge_titles": ["Howl's Moving Castle", "Princess Mononoke", "Your Name"],
        "radar": {
            "retention": 96,
            "capital_efficiency": 99,
            "churn_defense": 97,
    ...
    },
    {
        ...
        "ad_yield_cpm": 37.0,
        "ad_tolerance_minutes": 35,
        "bridge_titles": ["Dangal", "PK", "Taare Zameen Par"],
        "radar": {
            "retention": 93,
            "capital_efficiency": 100,
            "churn_defense": 98,
...
with open(OUTPUT_FILE, "w", encoding="utf-8") as f:
    json.dump(ENRICHED_TITLES, f, indent=2)

with open(ANALYTICS_FILE, "w", encoding="utf-8") as f:
    json.dump(ENRICHED_TITLES, f, indent=2)

print(f"✓ Wrote {len(ENRICHED_TITLES)} enriched blockbuster titles with churn, radar, and ad-tier metrics to {OUTPUT_FILE}")
